...
import kg.peaksoft.peaksoftlmsbb4.db.mapper.PresentationMapper;
...
public class PresentationServiceImpl implements PresentationService {
    ...
    public PresentationResponse savePresentation(PresentationRequest request) {
        ...
        if (lessons.getPresentation() == null) {
            Presentation presentation = presentationMapper.convert(request);
    ...
    public PresentationResponse update(Long id, PresentationRequest request) {
        ...
        if (!presentation.getName().equals(request.getName())) {
            presentation.setName(request.getName());
        }
        if (!presentation.getDescription().equals(request.getDescription())) {
